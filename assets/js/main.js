...
.stock[data-k="in"]::before{width:16px;height:16px;
...
.stock[data-k="in"]::after{content:'';position:absolute;inset-inline-start:0;top:50%;
  width:16px;height:16px;margin-top:-8px;border-radius:50%;pointer-events:none;
  border:1.5px solid rgba(78,122,60,.75);
